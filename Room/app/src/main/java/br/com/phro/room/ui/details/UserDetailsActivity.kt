...
import br.com.phro.room.MainActivity.Companion.ID
import br.com.phro.room.database.entity.User
import br.com.phro.room.databinding.ActivityUserDetailsBinding
...
class UserDetailsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        detailsViewModel.createRepository(database.userDAO())
