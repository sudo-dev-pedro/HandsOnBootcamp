...
class MockExtensionTest {
    ...
    @Test
    fun `should work with mockK extensions`() {
    ...
    @Test
    fun `when car is stopped and car should move`(@MockK car2: Car) {
    ...
    @Test
    fun `when relaced car is stopped and car should move`(@RelaxedMockK relaxedCar2: Car) {
        car2.drive(Direction.NORTH)
